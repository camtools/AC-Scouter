...
/* ==========================================
   8. LOGICA CIAK (TRIGGER, FLASH & SOUND)
   ========================================== */
...
clapSound.load(); // Forza il caricamento del file
...
if(trigger) {
    const startAction = (e) => {
        ...
        // Avviamo il timer per la Clean Mode (800ms)
    ...
    const stopAction = (e) => {
        ...
        // Se è un tocco rapido (non long press)
        if (!isLongPress) {
            executeCiakFlash();
        }
    };

    function executeCiakFlash() {
        // Riproduzione Audio (con reset per colpi rapidi)
